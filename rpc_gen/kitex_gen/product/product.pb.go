...
type ListProductIdsResp struct {
	state         protoimpl.MessageState
	sizeCache     protoimpl.SizeCache
	unknownFields protoimpl.UnknownFields
...
func (x *ListProductIdsResp) Reset() {
	*x = ListProductIdsResp{}
	if protoimpl.UnsafeEnabled {
...
func (x *ListProductIdsResp) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*ListProductIdsResp) ProtoMessage() {}

func (x *ListProductIdsResp) ProtoReflect() protoreflect.Message {
	mi := &file_product_proto_msgTypes[10]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use ListProductIdsResp.ProtoReflect.Descriptor instead.
func (*ListProductIdsResp) Descriptor() ([]byte, []int) {
	return file_product_proto_rawDescGZIP(), []int{10}
}

func (x *ListProductIdsResp) GetId() []uint32 {
	if x != nil {
		return x.Id
	}
	return nil
...
var file_product_proto_rawDesc = []byte{
	...
	0x74, 0x52, 0x07, 0x72, 0x65, 0x73, 0x75, 0x6c, 0x74, 0x73, 0x22, 0x88, 0x01, 0x0a, 0x10, 0x55,
	...
	0x70, 0x72, 0x69, 0x63, 0x65, 0x22, 0x3f, 0x0a, 0x11, 0x55, 0x70, 0x64, 0x61, 0x74, 0x65, 0x50,
	...
	0x72, 0x6f, 0x64, 0x75, 0x63, 0x74, 0x22, 0x24, 0x0a, 0x12, 0x4c, 0x69, 0x73, 0x74, 0x50, 0x72,
	0x6f, 0x64, 0x75, 0x63, 0x74, 0x49, 0x64, 0x73, 0x52, 0x65, 0x73, 0x70, 0x12, 0x0e, 0x0a, 0x02,
	0x69, 0x64, 0x18, 0x01, 0x20, 0x03, 0x28, 0x0d, 0x52, 0x02, 0x69, 0x64, 0x32, 0xf7, 0x02, 0x0a,
	...
	0x64, 0x75, 0x63, 0x74, 0x73, 0x52, 0x65, 0x73, 0x70, 0x22, 0x00, 0x12, 0x48, 0x0a, 0x0d, 0x55,
	...
	0x65, 0x73, 0x70, 0x22, 0x00, 0x12, 0x3f, 0x0a, 0x0e, 0x4c, 0x69, 0x73, 0x74, 0x50, 0x72, 0x6f,
	0x64, 0x75, 0x63, 0x74, 0x49, 0x64, 0x73, 0x12, 0x0e, 0x2e, 0x70, 0x72, 0x6f, 0x64, 0x75, 0x63,
	0x74, 0x2e, 0x45, 0x6d, 0x70, 0x74, 0x79, 0x1a, 0x1b, 0x2e, 0x70, 0x72, 0x6f, 0x64, 0x75, 0x63,
	0x74, 0x2e, 0x4c, 0x69, 0x73, 0x74, 0x50, 0x72, 0x6f, 0x64, 0x75, 0x63, 0x74, 0x49, 0x64, 0x73,
	0x52, 0x65, 0x73, 0x70, 0x22, 0x00, 0x42, 0x22, 0x5a, 0x20, 0x67, 0x6f, 0x6d, 0x61, 0x6c, 0x6c,
...
var file_product_proto_goTypes = []interface{}{
	...
	(*ListProductIdsResp)(nil), // 10: product.ListProductIdsResp
}
var file_product_proto_depIdxs = []int32{
	...
	2,  // 3: product.UpdateProductResp.product:type_name -> product.Product
	1,  // 4: product.ProductCatalogService.ListProducts:input_type -> product.ListProductsReq
	4,  // 5: product.ProductCatalogService.GetProduct:input_type -> product.GetProductReq
	6,  // 6: product.ProductCatalogService.SearchProducts:input_type -> product.SearchProductsReq
	8,  // 7: product.ProductCatalogService.UpdateProduct:input_type -> product.UpdateProductReq
	0,  // 8: product.ProductCatalogService.ListProductIds:input_type -> product.Empty
	3,  // 9: product.ProductCatalogService.ListProducts:output_type -> product.ListProductsResp
	5,  // 10: product.ProductCatalogService.GetProduct:output_type -> product.GetProductResp
	7,  // 11: product.ProductCatalogService.SearchProducts:output_type -> product.SearchProductsResp
	9,  // 12: product.ProductCatalogService.UpdateProduct:output_type -> product.UpdateProductResp
	10, // 13: product.ProductCatalogService.ListProductIds:output_type -> product.ListProductIdsResp
...
func file_product_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		...
		file_product_proto_msgTypes[10].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*ListProductIdsResp); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
...
type ProductCatalogService interface {
	...
	ListProductIds(ctx context.Context, req *Empty) (res *ListProductIdsResp, err error)
}
